  ...
  return (
    <>
      <section className="py-16 sm:py-20">
        <Container>
          <div className="max-w-3xl">
            <SectionTitle
              title="Qualificazioni"
              subtitle="Le qualificazioni riportate in questa pagina documentano l'idoneità di Costruzioni Generali Biasuzzi S.r.l. all'esecuzione di lavori pubblici nelle categorie per cui l'impresa risulta attestata."
              marker
            />
            <div className="mt-6 space-y-4 text-base leading-relaxed text-neutral-600">
              <p className="text-descriptive">
                L&apos;attestazione SOA in corso di validità comprende le categorie OG1, OG3,
                OG6, OG8, OG10, OG12, OS1 e OS23, con classifiche differenziate in
                funzione degli ambiti di intervento. A supporto
                dell&apos;organizzazione aziendale è inoltre presente la certificazione UNI EN ISO
                9001:2015 per il sistema di gestione per la qualità.
              </p>
              <p className="text-descriptive">
      ...
      <QualificationsPreview
        ...
        subtitle="Categorie SOA e relative classifiche di qualificazione."
        showButton={false}
        showDescriptions
      />
